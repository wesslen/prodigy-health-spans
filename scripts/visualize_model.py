...
def main():
    st.title("Health (med7) fine-tuned NER model")
    models = ["en_core_med7_lg","training/model-best","training/model-last"]
    default_text = "A patient was prescribed Magnesium hydroxide 400mg/5ml suspension PO of total 30ml bid for the next 5 days."
    ...
    metrics = srsly.read_json("training/metrics.json")
    st.json(metrics)
